...
<textarea 
  ...
  readOnly={
    !(['Approved_Step2', 'Approved_Step3'].includes(authUser.role_code) && promotion?.step === 'Waiting For Approved_Step1')
    || promotion?.ApprovedStep1 === true
    || promotion?.ApprovedStep1 === 1
  }
/>
    </div>
  </div>
  ...
  {/* เงื่อนไขการแสดงปุ่ม */}
  {promotion?.step === 'Waiting For Approved_Step1' && (authUser.role_code === 'Approved_Step2' || authUser.role_code === 'Approved_Step3') && (
...
/>
  ...
  readOnly={
    !(['Approved_Step2', 'Approved_Step3'].includes(authUser.role_code) && promotion?.step === 'Waiting For Approved_Step2')
    || promotion?.ApprovedStep2 === true
    || promotion?.ApprovedStep2 === 1
  }
/>
    </div>
  </div>
...
<textarea 
  ...
  readOnly={
    !(['Approved_Step2', 'Approved_Step3'].includes(authUser.role_code) && promotion?.step === 'Waiting For Approved_Step3')
    || promotion?.ApprovedStep3 === true
    || promotion?.ApprovedStep3 === 1
  }
/>  
  ...
  {/* เงื่อนไขการแสดงปุ่ม */}
  {promotion?.step === 'Waiting For Approved_Step3' && (authUser.role_code === 'Approved_Step2' || authUser.role_code === 'Approved_Step3') && (
    <div className='flex gap-4 p-2'>
      <button 
        className='bg-green-600 text-white rounded-lg px-4 py-2 hover:bg-green-500'  
        onClick={() => handleApproval('approve')}
...
/>  
  ...
  {/* เงื่อนไขการแสดงปุ่ม */}
  {promotion?.step === 'Waiting For Approved_Step4' && authUser.role_code === 'Approved_Step2' && (
    <div className='flex gap-4 p-2'>
      <button 
        className='bg-green-600 text-white rounded-lg px-4 py-2 hover:bg-green-500'  
        onClick={() => handleApproval('approve')}
